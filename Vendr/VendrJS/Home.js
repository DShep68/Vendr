...
function changeSnack(){
  ...
  function filterDrinkResults(filters) {
    var rElems = document.querySelectorAll(".snack");
    var hiddenElems = [];
  ...
  function filterSnackResults(filters) {
    var rElems = document.querySelectorAll(".drink");
    var hiddenElems = [];
